...
class OccupationalGroupAllocator:
    ...
    def _enhance_confidence(
        ...
        Combine with semantic similarity, inclusions, etc.
        """
        ...
        for rec in llm_result.top_recommendations:
            ...
            new_conf, breakdown = self.confidence_calc.calculate_confidence(
                ...
                inclusion_match='applies' in rec.inclusion_check.lower(),
...
```
  ...
  <done>OccupationalGroupAllocator orchestrates full pipeline, returns AllocationResult with provenance</done>
</task>
...
5. All recommendations include provenance_url
6. Recommendations filtered to >= 0.3 confidence
</verification>
...
- Final confidence uses multi-factor calculation, not just LLM score
